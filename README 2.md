jQuery SPApp.
===============================
**jQuery SPApp** is a simple jquery plugin that help to create single page application. The principle is quite simple.
...
Some rules:
 ...
 - The `<main>` tag need to have "jqueryspapp" id.
...
JS
-------------
When you have set your html you can write the javascript to run the plugin. First of all init the app via `$.jQuerySPApp()`, add your route and finally run the app. At the end you should have a snippet like this
```js
var app = $.jQuerySPApp({
...
After this you need to define your routes. The basic routes object was automatically created at the init of the plugin following the `<main id="jqueryspapp">` tag. To extend functionality you can define every single view with the `route()` method.
